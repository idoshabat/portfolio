      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        <div className="rounded-[8px] border-2 border-[var(--ink)] bg-[var(--cobalt)] p-5 shadow-[12px_12px_0_#171513]">
          <div className="aspect-[4/5] rounded-[8px] bg-[var(--paper)] p-6">
            <div className="flex h-full flex-col justify-between">
              ...
              <div>
              <p className="text-6xl font-black leading-none">התמונה שלך כאן</p>
                <p className="mt-4 text-black/58">הוסף תמונת פורטרט חזקה או צילום סטודיו שיוצר אמון.</p>
              </div>
            </div>
          </div>
        </div>
        <div>
          <SectionHeading
            ...
            copy="כתוב את זה בקול שלך. ספר למי אתה עוזר, איזה סוג עבודות אתה אוהב, מה הרקע שלך ואילו תוצאות עסקיות לקוחות יכולים לצפות לקבל."
          />
